...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col items-center text-white bg-dark h-full px-4 pb-[19px]">
      <div className="flex gap-10 justify-between items-center self-stretch py-3 w-full text-xs font-bold leading-6 bg-dark min-h-[48px] text-neutral-200 max-w-[600px] mx-auto">
        <button
      ...
      <div className="flex gap-2.5 justify-between items-center mt-[44px] w-full text-lg font-medium leading-none text-center whitespace-nowrap text-foreground max-w-[600px] mx-auto">
        {balanceLoading ? (
          <>
      ...
      <div className="flex flex-col w-full gap-[7px] mt-4 max-w-[600px] mx-auto">
        <CryptoBalance
          cryptoName="Bitcoin"
          cryptoAmount={
            balance
      ...
      <AnimatePresence>
        {showChooseReceiveCurrencySlide && (
          <motion.div
            ...
            onClick={handleToggleChooseReceiveCurrencySlide}>
            <motion.div
              className="w-full max-w-[600px] bg-neutral-900 p-4 rounded-t-lg"
              initial={{ y: '100%' }}
              animate={{ y: 0 }}
              exit={{ y: '100%' }}
