...
export const SendOptions: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col items-center text-white bg-dark h-full px-4 pt-12 pb-[19px]">
      ...
      <div className="flex flex-col mt-8 w-full text-lg font-bold leading-8 text-white max-w-[600px] mx-auto">
      ...
      <div className="flex flex-col mt-4 w-full items-end max-w-[600px] mx-auto">
      ...
      <Button className="absolute bottom-[19px]" onClick={handleNext} disabled={!btcAmount}>
        Next
      </Button>
    </div>
  );
