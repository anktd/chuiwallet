...
export const SendStatus: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col items-center text-white bg-dark h-full px-4 pt-12 pb-[19px]">
      <div className="flex flex-col items-center w-[54px] mt-8 max-w-[600px] mx-auto">
        <img
          loading="lazy"
      ...
      <div className="mt-8 text-2xl font-bold leading-none text-center text-white max-w-[600px] mx-auto">
        {currency ? currencyMapping[currency] : 'Unknown'} Sent
      </div>
      <div className="mt-5 text-lg leading-none text-center text-zinc-600 max-w-[600px] mx-auto">
        See the state of <span className="text-primary-yellow">your transaction</span>
      </div>
      <div className="mt-12 text-sm font-bold leading-none text-center text-white max-w-[600px] mx-auto">
        Transaction ID
      </div>
      <div className="flex flex-col justify-center items-center gap-2 relative mt-2 max-w-[600px] mx-auto">
      ...
      {states.status === 'success' ? (
        <Button className="absolute bottom-[19px]" onClick={handleDashboardClick}>
          Go to dashboard
        </Button>
      ) : (
        <Button className="absolute bottom-[19px]" onClick={handleRetryClick}>
          Retry
        </Button>
      )}
    </div>
