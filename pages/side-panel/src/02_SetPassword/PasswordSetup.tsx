...
export const PasswordSetup: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen px-5 pt-12 pb-[19px] bg-dark max-md:px-6 max-md:py-10 max-sm:px-4 max-sm:py-8">
      <div className="flex flex-col flex-1">
        ...
        <form
          ...
          className="flex flex-col justify-between mt-6 w-full flex-1 text-lg font-bold leading-8">
          <div>
