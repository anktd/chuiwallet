...
export const SetPassword: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col h-screen px-5 pt-12 pb-[19px] bg-dark">
      <div className="flex flex-col flex-1 max-w-[600px] mx-auto">
        ...
        <div className="flex flex-col justify-between mt-6 w-full flex-1 text-lg font-bold leading-8 gap-3">
          <div className="flex flex-col justify-start gap-3">
            ...
            <span className="mt-2 text-xs text-neutral-400 font-normal max-w-[600px] mx-auto">
      ...
      <Button className="absolute bottom-[19px]" onClick={handleNext} tabIndex={0} disabled={!termsAccepted}>
        Next
      </Button>
    </div>
  );
