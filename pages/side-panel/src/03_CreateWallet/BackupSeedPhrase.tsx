    ...
    <div className="flex overflow-hidden flex-col items-center px-2.5 pt-12 pb-7 bg-dark max-w-[375px]">
      <div className="flex flex-col justify-between self-stretch w-full text-center min-h-[408px]">
        <div className="flex flex-col w-full">
          ...
          <div className="mt-3 text-lg leading-none text-neutral-400">Write it down and keep it safe.</div>
        </div>
        <div className="flex gap-4 self-center mt-12 text-base leading-9 whitespace-nowrap min-h-[284px] text-neutral-400">
