...
export const BackupSeed: React.FC = () => {
  ...
  return (
    <div className="relative flex overflow-hidden flex-col items-center px-5 pt-12 pb-[19px] bg-dark h-full w-full">
      <div className="flex flex-col justify-between self-stretch w-full text-center min-h-[388px] max-w-[600px] mx-auto">
      ...
      <Button className="absolute bottom-[19px]" tabIndex={0} onClick={() => navigate('/onboard/verify-seed')}>
        Verify seed
      </Button>
    </div>
  );
