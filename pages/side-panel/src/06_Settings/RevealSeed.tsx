...
export const RevealSeed: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col text-white bg-dark h-full px-4 pt-12 pb-[19px]">
      ...
      <div className="mt-[60px] flex flex-col self-stretch w-full text-center min-h-[360px] px-[37.5px] gap-[24px] max-w-[600px] mx-auto">
      ...
      <Button className="absolute bottom-[19px]" tabIndex={0} onClick={() => navigate('/dashboard')}>
        Hide
      </Button>
    </div>
  );
