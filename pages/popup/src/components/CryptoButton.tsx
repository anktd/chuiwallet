...
export const CryptoButton: React.FC<CryptoButtonProps> = ({ icon, label, onClick }) => {
  return (
    <div
      ...
      className="flex gap-2.5 justify-center items-center self-stretch px-2.5 py-3.5 my-auto rounded-2xl border border-solid bg-zinc-800 border-stone-900 min-h-[50px] w-[168px]">
