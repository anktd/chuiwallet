  ...
  return (function (o) {
    ...
    function (o, e, r) {
      ...
      function l(o, e, r, c) {
        ...
        var a = 'attemptBoth' === s.inversionAttempts || 'invertFirst' === s.inversionAttempts,
          ...
          u = n(l ? k : B);
        return (
          u || ('attemptBoth' !== s.inversionAttempts && 'invertFirst' !== s.inversionAttempts) || (u = n(l ? B : k)), u
        );
      }
          ...
          var c = i[r.dataMask],
            ...
            a = (function (o) {
              ...
              return (
                ...
                o.versionNumber > 6 && (r.setRegion(e - 11, 0, 3, 6, !0), r.setRegion(0, e - 11, 6, 3, !0)),
                r
              );
            })(e),
            n = [],
          ...
          for (var C = 0; C < s; C++)
            for (var m = k ? s - 1 - C : C, f = 0; f < 2; f++) {
              ...
              if (!a.get(w, m)) {
                B++;
                var P = o.get(w, m);
                c({ y: m, x: w }) && (P = !P), (l = d(P, l)), 8 === B && (n.push(l), (B = 0), (l = 0));
              }
            }
          k = !k;
        }
    ...
    function (o, e, r) {
      ...
      e.decode = function (o, e) {
        ...
        r.set(o);
        for (
          var s = new t.default(285, 256, 0), a = new c.default(s, r), n = new Uint8ClampedArray(e), d = !1, l = 0;
          l < e;
          l++
        ) {
      ...
      function d(o, e, r) {
        try {
          var t = a(o, { x: -1, y: o.y }, r, e.length),
            ...
            d = a(o, { x: Math.min(r.width, o.x + o.y) + 1, y: Math.min(r.height, o.y + o.x) + 1 }, r, e.length),
            l = n(t, e),
            i = n(c, e),
            B = n(s, e),
            k = n(d, e),
            ...
            .map(function (e) {
              ...
              if (o.get(Math.floor(r), Math.floor(s))) {
                ...
                return {
                  x: r,
                  y: s,
                  score: d({ x: Math.floor(r), y: Math.floor(s) }, [1, 1, 1], o) + t({ x: r, y: s }, f),
                };
              }
            })
            .filter(function (o) {
      ...
      e.locate = function (o) {
        ...
        var k = e
          ...
          .map(function (e) {
            ...
            if (o.get(Math.round(r), Math.round(t))) {
              var s = [e.top.endX - e.top.startX, e.bottom.endX - e.bottom.startX, e.bottom.y - e.top.y + 1],
                a = c(s) / s.length;
              return { score: d({ x: Math.round(r), y: Math.round(t) }, [1, 1, 3, 1, 1], o), x: r, y: t, size: a };
            }
          })
          .filter(function (o) {
            return !!o;
          ...
          .map(function (o, e, r) {
            ...
            var t = r
              ...
              .map(function (e) {
                return { x: e.x, y: e.y, score: e.score + Math.pow(e.size - o.size, 2) / o.size, size: e.size };
              })
              .sort(function (o, e) {
                return o.score - e.score;
              });
        ...
        var u = (function (o, e, r) {
            ...
            return (
              ...
              (i.x - l.x) * (d.y - l.y) - (i.y - l.y) * (d.x - l.x) < 0 && ((d = (n = [i, d])[0]), (i = n[1])),
