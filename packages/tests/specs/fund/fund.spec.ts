...
test.describe('Buy tokens test', () => {
  ...
  test('should redirect to provider URL while funding STX', async ({ page, fundChooseCurrencyPage }) => {
  ...
  test('should redirect to provider URL while funding BTC', async ({ page, fundChooseCurrencyPage }) => {
