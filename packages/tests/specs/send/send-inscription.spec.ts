...
test.describe('Send inscription', () => {
  ...
  test.describe('valid send inscription data', () => {
    test('should show the inscription review step', async ({ sendPage, homePage }) => {
      ...
      const inscriptionSendButton = sendPage.page.getByTestId(SendCryptoAssetSelectors.PreviewSendTxBtn);
  ...
  test.describe('validation errors', () => {
    test('should show the insufficient balance error', async ({ globalPage, homePage, sendPage }) => {
    ...
    test('should show non-zero offset inscription error', async ({ globalPage, homePage, sendPage }) => {
  ...
  test('should show multiple inscription on utxo error', async ({ globalPage, homePage, sendPage }) => {
    await mockTestnetTestAccountInscriptionsRequests(globalPage.page, [mockInscriptionResp, mockInscriptionResp]);
    await homePage.selectTestnet();
    await sendPage.selectInscription();
