...
test.describe('Onboarding an existing user', () => {
  ...
  test.describe('Encryption key values', () => {
    ...
    test('that the encryption key is generated correctly against a known working value', async ({
      ...
      test
        ...
        .toEqual('d904f412b8d116540017c302f3f7033813c95902af5a067c7befcc34fa5e5290709f157f80548603a1e4f8edc2c0d5d7');
    });
  });
  test('going through the onboarding flow to sign in', async ({
    ...
    const walletState = await onboardingPage.page.evaluate(async () => window.debug.logPersistedStore());
    ...
    delete (testSoftwareAccountDefaultWalletState as any).softwareKeys.entities.default.encryptedSecretKey;
