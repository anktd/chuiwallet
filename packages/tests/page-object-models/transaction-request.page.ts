...
export class TransactionRequestPage {
  readonly confirmTransactionBtnSelector = createTestSelector(TransactionRequestSelectors.BtnConfirmTransaction);
  readonly feeToBePaidLabel = createTestSelector(SharedComponentsSelectors.FeeToBePaidLabel);
  readonly transactionRequestPage = createTestSelector(TransactionRequestSelectors.TransactionRequestPage);
