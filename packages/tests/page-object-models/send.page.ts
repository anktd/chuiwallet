...
export class SendPage {
  ...
  constructor(page: Page) {
    ...
    this.amountInputErrorLabel = this.page.getByTestId(SendCryptoAssetSelectors.AmountFieldInputErrorLabel);
    this.confirmationDetails = this.page.getByTestId(SendCryptoAssetSelectors.ConfirmationDetails);
    this.confirmationDetailsRecipient = this.page.getByTestId(SendCryptoAssetSelectors.ConfirmationDetailsRecipient);
    ...
    this.recipientChooseAccountButton = page.getByTestId(SendCryptoAssetSelectors.RecipientChooseAccountButton);
    ...
    this.recipientSelectFieldAddress = this.page.getByTestId(SendCryptoAssetSelectors.RecipientSelectFieldAddress);
    this.recipientSelectFieldBnsName = this.page.getByTestId(SendCryptoAssetSelectors.RecipientSelectFieldBnsName);
    this.recipientInput = this.page.getByTestId(SendCryptoAssetSelectors.RecipientFieldInput);
    this.recipientBnsAddressLabel = this.page.getByTestId(SendCryptoAssetSelectors.RecipientBnsAddressLabel);
  ...
  async selectInscription() {
    ...
    if (count === 1) {
      ...
      await this.page.getByTestId(SendCryptoAssetSelectors.InscriptionSendButton).click({ force: true });
    } else {
